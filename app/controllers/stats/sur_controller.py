...
from app.stats.sur.sur_stats_km1 import cal_report_sur_km1
from app.stats.sur.sur_stats_km2 import cal_report_sur_km2
from app.stats.sur.sur_stats_lt import cal_report_sur_lt
from app.stats.sur.sur_stats_lv import cal_report_sur_lv
...
async def sur_lv(param: SurParamLV):
    try:
        report = cal_report_sur_lv(param)
