...
from app.stats.reg.reg_stats_1 import cal_report_reg_1
from app.stats.reg.reg_stats_n import cal_report_reg_n
from app.stats.reg.reg_stats_log2 import cal_report_reg_log2
from app.stats.reg.reg_stats_logn import cal_report_reg_logn
...
async def reg_logn(param: RegParamLogN):
    try:
        report = cal_report_reg_logn(param)
