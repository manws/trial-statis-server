...
from app.stats.runs.runs_stats_bc import cal_result_runs_bc
from app.stats.runs.runs_stats_value1 import cal_result_runs_value1
from app.stats.runs.runs_stats_value2 import cal_result_runs_value2
from app.stats.runs.runs_stats_value3 import cal_result_runs_value3
...
async def runs_bc(param: RunsParamBC):
    try:
        report = cal_result_runs_bc(param)
...
async def runs_value1(param: RunsParamValue1):
    try:
        report = cal_result_runs_value1(param)
...
async def runs_value2(param: RunsParamValue2):
    try:
        report = cal_result_runs_value2(param)
...
async def runs_value3(param: RunsParamValue3):
    try:
        report = cal_result_runs_value3(param)
